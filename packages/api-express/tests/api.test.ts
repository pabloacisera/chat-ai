...
describe('API LLM Tests', () => {
  ...
  describe('POST /api/llm/q - Validation Tests', () => {
    it('should return 400 when input is missing', async () => {
      const response = await request(app).post('/api/llm/q').send({});
    ...
    it('should return 400 when model is missing', async () => {
      const response = await request(app).post('/api/llm/q').send({ input: 'Hello' });
    ...
    it('should return 400 when apiKey is missing', async () => {
      const response = await request(app).post('/api/llm/q').send({ input: 'Hello', model: 'gemini-2.5-flash' });
    ...
    it('should return error for unsupported model', async () => {
      ...
      expect(response.text).toContain('no soportado');
    });
  });

  describe('POST /api/llm/q - Gemini Model', () => {
  ...
  describe('POST /api/llm/q - Mistral Model', () => {
  ...
  describe('POST /api/llm/q - Groq Llama 3.3 Model', () => {
  ...
  describe('POST /api/llm/q - Groq Llama Model', () => {
  ...
  describe('POST /api/llm/q - System Prompt', () => {
  ...
  describe('POST /api/llm/q - Parameters', () => {
